...
public:
    QNode(qrviz * Myrviz);
    QNode(int argc, char** argv); // 假设这是构造函数声明
...
Q_SIGNALS:
    ...
    void mapUpdated(const nav_msgs::msg::OccupancyGrid::SharedPtr msg);
    void poseUpdated(const geometry_msgs::msg::Pose::SharedPtr pose);
